...
ns:RegisterLocale("deDE", {
    ...
    ["Clean Shadow-style skin for action buttons: cropped icons, thin border, dark backdrop. A lightweight Masque_Shadow alternative."] = "Sauberer Shadow-Stil-Skin für Aktionsbuttons: gecroppte Icons, dünner Rand, dunkler Hintergrund. Eine leichtgewichtige Masque_Shadow-Alternative.",
    ["Masque_Shadow-style skin for action buttons: black, rounded, soft drop-shadow. Lightweight Masque alternative with several styles."] = "Masque_Shadow-Stil-Skin für Aktionsbuttons: schwarz, abgerundet, weicher Schatten. Leichtgewichtige Masque-Alternative mit mehreren Stilen.",
    ["|cffaaaaaaA clean Shadow-style skin for the action buttons — cropped icons, a thin border and a dark backdrop. Lightweight alternative to Masque + Masque_Shadow.|r"] = "|cffaaaaaaEin sauberer Shadow-Stil-Skin für die Aktionsbuttons — gecroppte Icons, ein dünner Rand und ein dunkler Hintergrund. Leichtgewichtige Alternative zu Masque + Masque_Shadow.|r",
    ["|cffaaaaaaA clean skin for the action buttons — cropped icons, a thin border and a dark backdrop. Lightweight alternative to Masque + Masque_Shadow.|r"] = "|cffaaaaaaEin sauberer Skin für die Aktionsbuttons — gecroppte Icons, ein dünner Rand und ein dunkler Hintergrund. Leichtgewichtige Alternative zu Masque + Masque_Shadow.|r",
    ["Accent-colored border"] = "Akzentfarbener Rand",
    ...
    ["Shadow (square, black edge)"] = "Shadow (eckig, schwarzer Rand)",
    ["Accent (square, purple edge)"] = "Akzent (eckig, violetter Rand)",
    ["Rounded corners"] = "Abgerundete Ecken",
    ["Circle"] = "Kreis",
    ["Minimal (icon only)"] = "Minimal (nur Icon)",
    ["|cffaaaaaaWeakAuras icons: open Masque, set the \"WeakAuras\" group to \"Masque: Shadow 1\" for the same black rounded look.|r"] = "|cffaaaaaaWeakAuras-Icons: Öffne Masque und stelle die \"WeakAuras\"-Gruppe auf \"Masque: Shadow 1\" für den gleichen schwarz-abgerundeten Look.|r",
    ["|cffaaaaaaMasque detected. Your action bars are registered with Masque and skinned with \"Masque: Shadow 1\" — the same texture WeakAuras uses, so both match.|r"] = "|cffaaaaaaMasque erkannt. Deine Aktionsleisten sind bei Masque registriert und mit \"Masque: Shadow 1\" geskinnt — die gleiche Textur wie WeakAuras, also passen beide zusammen.|r",
    ["Open Masque"] = "Masque öffnen",
    ["Open Masque to pick a different skin or tweak the groups (VuloClassicUI / Action Bars & Pet & Stance)."] = "Masque öffnen, um einen anderen Skin zu wählen oder die Gruppen anzupassen (VuloClassicUI / Action Bars & Pet & Stance).",
    ["Reset bars to Shadow 1"] = "Leisten auf Shadow 1 zurücksetzen",
    ["Force the action-bar groups back to the \"Masque: Shadow 1\" skin."] = "Setzt die Aktionsleisten-Gruppen zurück auf den \"Masque: Shadow 1\"-Skin.",
    ["|cffaaaaaaWeakAuras icons: open Masque, set the \"WeakAuras\" group to \"Masque: Shadow 1\" for the exact same look.|r"] = "|cffaaaaaaWeakAuras-Icons: Öffne Masque und stelle die \"WeakAuras\"-Gruppe auf \"Masque: Shadow 1\" für exakt den gleichen Look.|r",
    ["|cffaaaaaaInstall Masque + Masque_Shadow for the full textured look on bars and WeakAuras.|r"] = "|cffaaaaaaInstalliere Masque + Masque_Shadow für den vollen Textur-Look auf Leisten und WeakAuras.|r",
    ["|cffaaaaaaShadow-1 look for the action bars — no Masque required. Cropped icons with a soft black drop-shadow.|r"] = "|cffaaaaaaShadow-1-Look für die Aktionsleisten — kein Masque nötig. Gecroppte Icons mit weichem schwarzem Schatten.|r",
    ["Also skin WeakAuras icons"] = "Auch WeakAuras-Icons skinnen",
    ["|cffaaaaaaWeakAuras icons are handled by Masque (installed). To skin them with VuloClassicUI instead, uninstall Masque — then this toggle takes over.|r"] = "|cffaaaaaaWeakAuras-Icons werden von Masque (installiert) verwaltet. Damit VuloClassicUI sie skinnt, deinstalliere Masque — dann übernimmt dieser Schalter.|r",
    ["|cffaaaaaaWeakAuras icons get the same soft shadow. Re-open this panel or /reload if a new aura isn't skinned yet.|r"] = "|cffaaaaaaWeakAuras-Icons bekommen den gleichen weichen Schatten. Panel neu öffnen oder /reload, falls eine neue Aura noch nicht geskinnt ist.|r",
    ["|cffaaaaaaWeakAuras icons get the same soft shadow. If Masque also skins them you may see a double edge — disable Masque's WeakAuras group then.|r"] = "|cffaaaaaaWeakAuras-Icons bekommen den gleichen weichen Schatten. Falls Masque sie auch skinnt, siehst du evtl. einen doppelten Rand — deaktiviere dann Masques WeakAuras-Gruppe.|r",
    ["|cffaaaaaaMasque detected: WeakAuras icons are set to the exact \"Masque: Shadow 1\" skin automatically. (Action bars use VuloClassicUI's own skin — Masque doesn't touch Blizzard bars.)|r"] = "|cffaaaaaaMasque erkannt: WeakAuras-Icons werden automatisch auf den exakten \"Masque: Shadow 1\"-Skin gesetzt. (Aktionsleisten nutzen VuloClassicUIs eigenen Skin — Masque berührt Blizzard-Leisten nicht.)|r",
    ["|cffaaaaaaWeakAuras icons get VuloClassicUI's own rim. For the exact Masque Shadow 1 look on auras, enable Masque + Masque_Shadow — it'll be applied automatically.|r"] = "|cffaaaaaaWeakAuras-Icons bekommen VuloClassicUIs eigenen Rand. Für den exakten Masque-Shadow-1-Look auf Auren aktiviere Masque + Masque_Shadow — er wird automatisch angewendet.|r",
    ["|cffaaaaaaNote: turning the skin off fully reverts after a /reload.|r"] = "|cffaaaaaaHinweis: Skin ausschalten wird nach /reload vollständig rückgängig gemacht.|r",
    ["Also skin pet & stance buttons"] = "Auch Begleiter- & Haltungs-Buttons skinnen",
    ["|cffaaaaaaNote: turning the skin off fully reverts after a /reload. Works on Blizzard's default bars; if you use another action-bar addon, let it handle skinning instead.|r"] = "|cffaaaaaaHinweis: Skin ausschalten wird nach /reload vollständig rückgängig gemacht. Funktioniert mit Blizzards Standard-Leisten; wenn du ein anderes Aktionsleisten-Addon nutzt, lass dieses das Skinning übernehmen.|r",
