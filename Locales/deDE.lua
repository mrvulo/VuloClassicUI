...
ns:RegisterLocale("deDE", {
    ...
    -- =====================================================
    ["Chat"] = "Chat",
    ["Polishes Blizzard's chat: a dark panel with an icon sidebar, timestamps, class-coloured names, clickable links, short channel tags, dark tabs, idle fade and history that survives a /reload. Every part is optional."] = "Verbessert Blizzards Chat: ein dunkles Panel mit Icon-Sidebar, Zeitstempel, Namen in Klassenfarbe, klickbare Links, kurze Kanal-Tags, dunkle Tabs, Abblenden bei Inaktivität und Verlauf, der ein /reload übersteht. Jeder Teil ist optional.",
    ...
    ["Short channel tags"] = "Kurze Kanal-Tags",
    ["Shows just the channel number, e.g. [1. General] becomes [1]."] = "Zeigt nur die Kanalnummer, z. B. wird aus [1. Allgemein] dann [1].",
