...
ns:RegisterLocale("deDE", {
    ...
    ["|cffaaaaaaBuilt-in dark drop-shadow skin for the action bars. Cropped icons with a soft black rounded rim.|r"] = "|cffaaaaaaEingebauter dunkler Schatten-Skin für die Aktionsleisten. Gecroppte Icons mit weichem schwarzem abgerundetem Rand.|r",
    ["Style"] = "Stil",
    ...
    ["|cffaaaaaaWeakAuras icons get the same dark rounded rim as the bars. Re-open this panel or /reload if a new aura isn't skinned yet.|r"] = "|cffaaaaaaWeakAuras-Icons bekommen den gleichen dunklen abgerundeten Rand wie die Leisten. Panel neu öffnen oder /reload, falls eine neue Aura noch nicht geskinnt ist.|r",
