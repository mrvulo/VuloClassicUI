...
ns:RegisterLocale("deDE", {
    ...
    ["A slim bar left of the chat with copy, settings and scroll-to-bottom icons."] = "Eine schmale Leiste links vom Chat mit Kopier-, Einstellungs- und Nach-unten-scrollen-Icons.",
