...
ns:RegisterLocale("deDE", {
    ...
    ["|cffaaaaaaClickable totem bar: one click recasts the element's totem. Totems are learned from what you cast; pick a different one per element or switch sets below. A warning shows (and optionally a sound plays) before a totem expires.|r"] = "|cffaaaaaaKlickbare Totem-Leiste: ein Klick stellt das Totem des Elements neu. Totems werden aus deinen Casts gelernt; wähle pro Element ein anderes oder schalte unten zwischen Sets um. Eine Warnung (und optional ein Ton) erscheint, bevor ein Totem ausläuft.|r",
    ...
    ["Totem per element"] = "Totem pro Element",
