...
ns:RegisterLocale("deDE", {
    ...
    ["Reagent count"] = "Reagenz-Zählung",
    ["Shows an item's count as the stack number on spell icons — e.g. Soul Shards on Soul Fire. Needs 'Show stacks' on."] = "Zeigt die Item-Anzahl als Stapelzahl auf Zauber-Icons – z. B. Seelensplitter auf Seelenfeuer. Benötigt aktives „Stapel anzeigen\".",
