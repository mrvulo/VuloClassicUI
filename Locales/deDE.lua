...
ns:RegisterLocale("deDE", {
    ...
    ["Auto-Switch on Talent Spec"] = "Auto-Wechsel bei Talent-Spec",
    ["Enable spec auto-switching"] = "Spec-Auto-Wechsel aktivieren",
    ["Automatically equips a loadout based on your dominant talent tree. TBC has no live spec switch, so this triggers when you respec or on login. Bind each loadout to a talent tree below."] = "Legt automatisch ein Set basierend auf deinem dominanten Talentbaum an. TBC hat keinen Live-Spec-Wechsel, daher wird dies beim Umskillen oder Einloggen ausgelöst. Binde unten jedes Set an einen Talentbaum.",
    ["Auto-equip on spec"] = "Auto-Anlegen bei Spec",
    ["Equip this loadout automatically when this talent tree becomes your dominant spec (after a respec or on login)."] = "Legt dieses Set automatisch an, wenn dieser Talentbaum zu deiner dominanten Spec wird (nach Umskillen oder beim Einloggen).",
    ["Spec %d"] = "Spec %d",
    ["None"] = "Keine",
