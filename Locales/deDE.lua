...
ns:RegisterLocale("deDE", {
    ...
    ["Buttons"] = "Knöpfe",
    ["Hide zoom buttons"] = "Zoom-Knöpfe ausblenden",
    ["The mouse wheel always zooms; the +/- buttons are just clutter."] = "Das Mausrad zoomt immer; die +/- Knöpfe sind nur unnötiger Kram.",
