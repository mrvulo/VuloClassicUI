...
vt:AddOverriddenSpells(backstab,kidneyShot,garrote,sinisterStrike,kick,gouge,stealth,vanish,rupture,feint,sap,eviscerate,deadlyPoison,sprint,cripplingPoison,sliceandDice,evasion,mindnumbingPoison,exposeArmor,ambush,instantPoison,envenom,mutilate)
vt.SpellsByLevel = {
	[1] = {{id = 1784, cost = 10},},
