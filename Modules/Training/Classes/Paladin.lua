...
if (vt.currentClass ~= "PALADIN") then
	return
end
...
vt:AddOverriddenSpells(devotionAura,layonHands,retributionAura,shadowResistanceAura,frostResistanceAura,fireResistanceAura,spiritualAttunement)
vt.SpellsByLevel = vt.FactionFilter({
	[1] = {{id = 465, cost = 10},},
