...
vt:AddOverriddenSpells(demoralizingRoar,swipe,rip,claw,rake,dash,bash,prowl,tigersFury,shred,ravage,maul,cower,pounce,ferociousBite,frenziedRegeneration,mangleCat,mangleBear,faerieFireFeral)
vt.SpellsByLevel = {
	[1] = {{id = 1126, cost = 10},},
