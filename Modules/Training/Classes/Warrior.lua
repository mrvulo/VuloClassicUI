local _, ns = ...; local vt = ns.VTData
if (vt.currentClass ~= "WARRIOR") then
	return
end
...
vt:AddOverriddenSpells(shieldBash,heroicStrike,charge,mockingBlow,rend,cleave,demoralizingShout,slam,hamstring,battleShout,execute,thunderClap,pummel,revenge,overpower,sunderArmor,intercept,mortalStrike,devastate,bloodthirst,shieldSlam,rampage)
vt.SpellsByLevel = {
	[1] = {{id = 6673, cost = 10},},
