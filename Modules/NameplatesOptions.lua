    ...
    local all = {
        ...
        { type = "section", title = L["Colours"], items = {
            ...
            { type = "checkbox", label = L["Darken enemies out of combat"],
              ...
              subOptions = {
                  { type = "slider", label = L["Darken to (%)"], min = 20, max = 90, step = 5, width = SLW,
        ...
        { type = "section", title = L["Cast Bar"], items = {
            ...
            { type = "checkbox", label = L["Show who the cast is aimed at"],
              tooltip = L["The caster's current target, beside the cast bar. Your own name is coloured."],
              get = function() return mod.db.castTargetText end,
              set = function(_, v) mod.db.castTargetText = v; applyAndRefresh() end,
              subOptions = {
                  { type = "slider", label = L["Cast target size"], min = 0, max = 20, step = 1, width = SLW,
                    tooltip = L["0 = uses the general text size."],
                  ...
                  { type = "group", layout = "row", gap = 8, items = {
                      { type = "slider", label = L["Offset X"], min = -100, max = 100, step = 1, width = SLW,
                        get = function() return mod.db.castTargetX or 6 end,
            ...
            { type = "checkbox", label = L["Cast bars in front of other plates"],
              tooltip = L["In a pull the plates overlap and a cast bar can end up behind the plate in front of it."],
              get = function() return mod.db.castInFront end,
        ...
        { type = "section", title = L["Target & Threat"], items = {
            ...
            { type = "checkbox", label = L["Arrows beside your target"],
            ...
            { type = "checkbox", label = L["Mouseover highlight"],
              ...
              subOptions = {
                  { type = "slider", label = L["Highlight strength"], min = 2, max = 60, step = 2, width = SLW,
            ...
            { type = "checkbox", label = L["Mark on the focus plate"],
              ...
              subOptions = {
                  ...
                  { type = "dropdown", label = L["Mark position"], width = 260,
                  ...
                  { type = "group", layout = "row", gap = 8, items = {
                      { type = "slider", label = L["Mark size"], min = 0, max = 32, step = 1, width = SLW,
                        tooltip = L["0 = uses the name size."],
                        get = function() return mod.db.focusMarkSize or 0 end,
                        set = function(_, v) mod.db.focusMarkSize = v; applyAndRefresh() end },
                      { type = "color", label = L["Mark colour"], width = 160,
                        get = function() return mod.db.colFocusMark end,
                        set = function(r, g, b) mod.db.colFocusMark = { r = r, g = g, b = b }; applyAndRefresh() end },
                  } },
              } },
