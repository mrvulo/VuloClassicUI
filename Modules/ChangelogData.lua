...
ns.CHANGELOG = {
    { version = "1.60.0", sections = {
        { category = "Combat Meter", lines = {
            ...
            "Open as many windows as you need: the title menu adds a window for any mode and closes one again, and every window keeps its own mode, segment, position and size while the look and the visibility rules are shared.",
