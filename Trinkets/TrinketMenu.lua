...
-- VCUI-Patch: war GetAddOnMetadata("TrinketMenu",...) → nil weil als VuloClassicUI eingebettet
TrinketMenu_Version = (C_AddOns and C_AddOns.GetAddOnMetadata and C_AddOns.GetAddOnMetadata("VuloClassicUI", "Version")) or "embedded"
BINDING_HEADER_VULOCLASSICUI_TRINKETS = "VuloClassicUI – Trinkets"
setglobal("BINDING_NAME_CLICK TrinketMenu_Trinket0:LeftButton", "Trinket-Slot oben")
setglobal("BINDING_NAME_CLICK TrinketMenu_Trinket1:LeftButton", "Trinket-Slot unten")
